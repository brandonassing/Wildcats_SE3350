...
router.route('/')
    ...
    .get(parseUrlencoded, parseJSON, function (request, response) {
        ...
        if (!HighSchoolCourse) {
            ...
            models.SecondarySchools.find({
                "highSchoolCourse": HighSchoolCourse.highSchoolCourse
            }, function (error, highSchoolCourses) {
                if (error) response.send(error);
                response.json({
                    secondarySchool: highSchoolCourses
                });
            });
        }
    });
